...
def addHeader(f):
	...
	nMap_Header += '<?xml-stylesheet href="file:///opt/OnePunchScan/nmap-bootstrap.xsl" type="text/xsl"?>'
	nMap_Header += '<!-- Nmap Merged -->'
	nMap_Header += '<nmaprun scanner="nmap" args="" start="1" startstr="" version="7.70" xmloutputversion="1.04">'
